...
--tab -e 'bash -c "sleep 15; source ../../../devel/setup.bash;rosrun offboard_pkg t265_to_mavros; exec bash"' \
--tab -e 'bash -c "sleep 16; ./ttyTHS0.sh; exec bash"' \
--tab -e 'bash -c "sleep 18; roslaunch mavros px4.launch; exec bash"' \
--tab -e 'bash -c "sleep 20; source ../../../devel/setup.bash;roslaunch offboard_pkg setpoint.launch; exec bash"' \
